...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sujetos_persona', 'correo_electronico', self.gf('django.db.models.fields.EmailField')(max_length=70))

    def backwards(self, orm):

        # Changing field 'Persona.correo_electronico'
        db.alter_column(u'sujetos_persona', 'correo_electronico', self.gf('django.db.models.fields.EmailField')(max_length=75))
    ...
    models = {
        u'sujetos.persona': {
            ...
            'correo_electronico': ('django.db.models.fields.EmailField', [], {'max_length': '70', 'blank': 'True'}),
