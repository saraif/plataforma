...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.direccion'
        db.add_column(u'sujetos_persona', 'direccion',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.direccion'
        db.delete_column(u'sujetos_persona', 'direccion')
    ...
    models = {
        u'sujetos.persona': {
            ...
            'direccion': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '60'}),
