...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.correo_electronico'
        db.alter_column(u'sujetos_persona', 'correo_electronico', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Persona.correo_electronico'
        db.alter_column(u'sujetos_persona', 'correo_electronico', self.gf('django.db.models.fields.EmailField')(default='', max_length=70))
    ...
    models = {
        u'sujetos.persona': {
            ...
            'correo_electronico': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'unique': 'True', 'null': 'True'}),
