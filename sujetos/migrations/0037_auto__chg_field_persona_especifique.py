...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.especifique'
        db.alter_column(u'sujetos_persona', 'especifique', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # Changing field 'Persona.especifique'
        db.alter_column(u'sujetos_persona', 'especifique', self.gf('django.db.models.fields.CharField')(default=0, max_length=60))
