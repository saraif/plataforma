...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Vigia_persona', (
            ...
            ('estado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Vigia.Estado'], null=True, blank=True)),
            ('municipio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Vigia.Municipio'], null=True, blank=True)),
        ...
        db.send_create_signal(u'Vigia', ['Persona'])

        # Adding M2M table for field proyecto on 'Persona'
        m2m_table_name = db.shorten_name(u'Vigia_persona_proyecto')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('persona', models.ForeignKey(orm[u'Vigia.persona'], null=False)),
            ('proyecto', models.ForeignKey(orm[u'Vigia.proyecto'], null=False))
        ))
        db.create_unique(m2m_table_name, ['persona_id', 'proyecto_id'])

        # Adding model 'Proyecto'
        db.create_table(u'Vigia_proyecto', (
        ...
        db.send_create_signal(u'Vigia', ['Proyecto'])

        # Adding model 'Estado'
        db.create_table(u'Vigia_estado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre_estado', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'Vigia', ['Estado'])

        # Adding model 'Municipio'
        db.create_table(u'Vigia_municipio', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre_municipio', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'Vigia', ['Municipio'])


    def backwards(self, orm):
        # Deleting model 'Persona'
        db.delete_table(u'Vigia_persona')

        # Removing M2M table for field proyecto on 'Persona'
        db.delete_table(db.shorten_name(u'Vigia_persona_proyecto'))

        # Deleting model 'Proyecto'
        db.delete_table(u'Vigia_proyecto')

        # Deleting model 'Estado'
        db.delete_table(u'Vigia_estado')

        # Deleting model 'Municipio'
        db.delete_table(u'Vigia_municipio')
    ...
    models = {
        ...
        u'Vigia.persona': {
            ...
            'estado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Vigia.Estado']", 'null': 'True', 'blank': 'True'}),
            'fecha_nacimiento': ('django.db.models.fields.DateField', [], {}),
            'indigena': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '1'}),
            'municipio': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Vigia.Municipio']", 'null': 'True', 'blank': 'True'}),
            'nombres': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'numero_telefono': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'proyecto': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Vigia.Proyecto']", 'symmetrical': 'False', 'blank': 'True'}),
