...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field fk_municipio on 'Parroquia'
        m2m_table_name = db.shorten_name(u'sujetos_parroquia_fk_municipio')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('parroquia', models.ForeignKey(orm[u'sujetos.parroquia'], null=False)),
            ('municipio', models.ForeignKey(orm[u'sujetos.municipio'], null=False))
        ))
        db.create_unique(m2m_table_name, ['parroquia_id', 'municipio_id'])


    def backwards(self, orm):
        # Removing M2M table for field fk_municipio on 'Parroquia'
        db.delete_table(db.shorten_name(u'sujetos_parroquia_fk_municipio'))
