...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Municipio.fk_parroquia'
        db.delete_column(u'sujetos_municipio', 'fk_parroquia_id')


    def backwards(self, orm):
        # Adding field 'Municipio.fk_parroquia'
        db.add_column(u'sujetos_municipio', 'fk_parroquia',
