...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proyecto.municipioid'
        db.add_column(u'sujetos_proyecto', 'municipioid',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sujetos.Municipio'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Proyecto.municipioid'
        db.delete_column(u'sujetos_proyecto', 'municipioid_id')
    ...
    models = {
        ...
        u'sujetos.proyecto': {
            ...
            'municipioid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sujetos.Municipio']", 'null': 'True', 'blank': 'True'}),
